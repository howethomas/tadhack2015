...
class VolunteersControllerTest < ActionController::TestCase
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post :create, volunteer: { mobile: @volunteer.mobile, name: @volunteer.name, twitter_handle: @volunteer.twitter_handle }
    end
  ...
  test "should update volunteer" do
    patch :update, id: @volunteer, volunteer: { mobile: @volunteer.mobile, name: @volunteer.name, twitter_handle: @volunteer.twitter_handle }
    assert_redirected_to volunteer_path(assigns(:volunteer))
  end
